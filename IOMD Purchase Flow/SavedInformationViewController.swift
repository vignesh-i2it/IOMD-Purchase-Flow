...
class SavedInformationViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var cardData: [[String: String]] = [
        ["firstName": "John", "lastName": "Doe", "cardNumber": "•••• 5678", "expiryDate": "12/25"],
        ["firstName": "Jane", "lastName": "Smith", "cardNumber": "•••• 5432", "expiryDate": "08/23"]
    ]
...
//        tableView.register(CardsCellTableViewCell.self, forCellReuseIdentifier: "CardsCellTableViewCell")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if isButton3Active {
            ...
            cell.eyeButtonAction = { [weak self] in
